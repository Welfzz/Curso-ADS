	...
	public visual_segundo() {
		...
		btn_ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sexo[]={"M", "F"};
				JComboBox escolha_sexo = new JComboBox(sexo);
				
				UmaPessoa.setNome(texto_nome.getText());
				
				UmaPessoa.setSexo(((String) escolha_sexo.getSelectedItem()).charAt(0));
		...
		String sexo[]={"M", "F"};
		JComboBox escolha_sexo = new JComboBox(sexo);
		escolha_sexo.setSelectedIndex(1);
		escolha_sexo.setBounds(66, 87, 231, 22);
		contentPane.add(escolha_sexo);
	}
}
