...
public class visual_segundo extends JFrame {
	...
	public visual_segundo() {
		...
		JRadioButton radio_sexo2 = new JRadioButton("F");
		radio_sexo2.setBounds(103, 88, 37, 23);
		contentPane.add(radio_sexo2);
		
		JRadioButton radio_sexo1 = new JRadioButton("M");
		radio_sexo1.setBounds(62, 88, 37, 23);
		contentPane.add(radio_sexo1);
		
		ButtonGroup grupo = new ButtonGroup();
		
		grupo.add(radio_sexo1);
		grupo.add(radio_sexo2);
		...
		btn_ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(radio_sexo1.isSelected()){
			         UmaPessoa.setSexo(radio_sexo1.getText().charAt(0));
				}
				if(radio_sexo2.isSelected()){
					UmaPessoa.setSexo(radio_sexo2.getText().charAt(0));
				}
